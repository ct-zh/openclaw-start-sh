...
Build time (PPR enabled)
Content pre-rendered into static shell
No - fallback never shown
...
Runtime - cache miss
Async function executes, component suspends
Yes - for better UX
...
'minutes'
Optional
~5 min expiry, occasional misses
